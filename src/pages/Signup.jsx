      ...
      <section className="w-full sm:max-w-lg py-6 px-8 mx-auto m-8 rounded shadow-md">
        ...
        <form>
          <div className="relative">
            ...
            <AiOutlineUser className="absolute top-3 left-3 text-lg text-gray-500" />
          </div>
          <div className="relative">
            <input 
              className="mb-3 w-full rounded pl-8 border-[2px] border-gray-300/50 text-gray-500 focus:border-gray-400 focus:ring-gray-500 focus:ring-0 sm:text-sm" 
          ...
          <button className="rounded bg-red-500 text-white text-center w-full cursor-pointer py-2 font-semibold hover:bg-red-600 active:bg-red-700 mt-4 block mb-5" >Sign up</button>
          ...
          <div className="flex items-center  my-4 before:border-t before:flex-1 before:border-gray-300 after:border-t after:flex-1 after:border-gray-300">
            ...
            <OAuth />
            <p className="text-center">Already have an account?<Link to="/sign-in" className="text-blue-900 ml-2 font-semibold transition duration-200 ease-in-out">Sign in.</Link></p>
